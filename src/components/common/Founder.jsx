    ...
    return (
        <div className='text-center mt-10'>
            ...
            <div className='mx-auto founder-card border border-solid drop-shadow-2xl rounded-xl max-w-80 z-0'>
                ...
                <div>
                    <div className='pb-5 font-semibold text-lg'>Ravindra Bhand</div>
                    <div>Python is one of the most demanded programming languages in the job market. Surprisingly, it is equally easy to learn and master Python. Let's commit our 100 days of code to python!</div>
                </div>
            </div>
        </div>
    );
